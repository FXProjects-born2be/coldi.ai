...
const rows: Row[] = [
  {
    feature: 'Deployment',
    without: 'Internal build, slow',
    withColdi: 'Fully managed, fast',
  },
  {
    feature: 'Customization',
    without: 'Limited templates',
    withColdi: 'Tailored to use cases',
  },
  {
    feature: 'Integration',
    without: 'Fragmented systems',
    withColdi: 'End‑to‑end connectivity',
  },
  {
    feature: 'Conversational quality',
    without: 'Rigid, static',
    withColdi: 'Natural, adaptive',
  },
  {
    feature: 'Support',
    without: 'One‑off project',
    withColdi: 'Continuous improvement',
  },
  {
    feature: 'Maintenance',
    without: 'Customer responsibility',
    withColdi: 'Ongoing tuning',
  },
];
