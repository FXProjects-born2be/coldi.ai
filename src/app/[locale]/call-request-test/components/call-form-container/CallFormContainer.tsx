...
} from '@/features/request-call-test/model/schemas';
import type { Agent } from '@/features/request-call-test/store/store';
import { useRequestCallStore } from '@/features/request-call-test/store/store';
import { FirstStepToCall } from '@/features/request-call-test/ui/first-step-to-call';
import { SecondStepToCall } from '@/features/request-call-test/ui/second-step-to-call';
import { StillLikeGetCall } from '@/features/request-call-test/ui/still-like-get-call';
...
const ThankYouDialog = dynamic(
  () =>
    import('@/features/request-call-test/ui/thank-you-dialog').then((mod) => mod.ThankYouDialog),
  { ssr: false }
);

const UnsupportedCountryDialog = dynamic(
  () =>
    import('@/features/request-call-test/ui/unsupported-country-dialog').then(
