...
const cards = [
  {
    ...
    title: t('products.customerServiceAgent.features.cards.0.title', 'Always-On Engagement'),
    description: t(
      'products.customerServiceAgent.features.cards.0.description',
  ...
  },
  {
    ...
    title: t('products.customerServiceAgent.features.cards.1.title', 'Context-Aware Conversations'),
    description: t(
      'products.customerServiceAgent.features.cards.1.description',
  ...
  },
  {
    ...
    title: t('products.customerServiceAgent.features.cards.2.title', 'Integrated Workflows'),
    description: t(
      'products.customerServiceAgent.features.cards.2.description',
  ...
  },
  {
    ...
    title: t('products.customerServiceAgent.features.cards.3.title', 'Analytics & Insight'),
    description: t(
      'products.customerServiceAgent.features.cards.3.description',
  ...
  },
  {
    ...
    title: t('products.customerServiceAgent.features.cards.4.title', 'Seamless Scalability'),
    description: t(
      'products.customerServiceAgent.features.cards.4.description',
...
export const Features = () => {
  ...
  return (
    <section className={st.layout}>
      ...
      >
        {t(
          'products.customerServiceAgent.features.title',
