...
const rows: Row[] = [
  {
    ...
    withColdi: 'Fully managed',
  },
  {
    feature: 'Call handling',
    without: 'VoIP only',
    withColdi: 'AI + VoIP combined',
  },
  {
    feature: 'Scalability',
    without: 'Limited by infrastructure',
    withColdi: 'End-to-end connectivity',
  },
  {
    feature: 'International calls',
    without: 'Requires multiple providers',
    withColdi: 'Built-in',
  },
  {
    feature: 'Automation',
  ...
  {
    feature: 'Support',
    without: 'Self-managed',
    withColdi: 'Continuous improvement',
  },
  {
    feature: 'Integration',
    without: 'Fragmented tools',
    withColdi: 'Fully connected systems',
  },
];
