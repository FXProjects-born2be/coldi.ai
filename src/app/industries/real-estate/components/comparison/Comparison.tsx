...
const rows: Row[] = [
  {
    ...
    without: 'Limited to agent availability',
    withColdi: 'Instant, 24/7',
  },
  {
    feature: 'Inbound inquiries',
    without: 'Manual answering/Voicemail',
    withColdi: 'Automated screening',
  },
  {
    feature: 'Showing scheduling',
    without: 'Back-and-forth texting/calling',
    withColdi: 'AI-assisted and instant',
  },
  {
    feature: 'Lead qualification',
    without: 'High manual workload',
    withColdi: 'Automated in real time',
  },
  {
    feature: 'Multilingual reach',
    without: 'Limited by staff skills',
    withColdi: '30+ languages',
  },
  {
    feature: 'Operational workload',
    without: 'Buried in cold calling/admin',
    withColdi: 'Focus on high-value closings',
  },
  {
    feature: 'Scalability',
    without: 'Requires hiring more assistants',
    withColdi: 'Unlimited simultaneous calls',
  },
];
