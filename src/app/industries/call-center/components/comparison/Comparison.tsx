...
const rows: Row[] = [
  {
    feature: 'Customer call response time',
    without: 'Limited to business hours',
    withColdi: 'Instant',
  },
  {
    feature: 'Routine inquiries',
    without: 'Manual agent workflows',
    withColdi: 'Automated responses',
  },
  {
    feature: 'Lead qualification',
    without: 'Manual outreach',
    withColdi: 'AI\u2011assisted and instant',
  },
  {
    feature: 'Outbound campaigns',
    without: 'Human\u2011dependent',
    withColdi: 'AI\u2011powered and scalable',
  },
  {
    feature: 'Multilingual communication',
    without: 'Limited to available staff',
    withColdi: 'Support in many languages',
  },
  {
    feature: 'Operational workload',
    without: 'High agent pressure',
    withColdi: 'Reduced for staff',
  },
  {
    feature: 'Scalability',
    without: 'Requires hiring more staff',
    withColdi: 'Unlimited automated calls',
  },
];
