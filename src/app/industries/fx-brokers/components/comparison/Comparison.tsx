...
const rows: Row[] = [
  {
    feature: 'Response Time during Volatility',
    without: 'Long wait times; high abandonment',
    withColdi: 'Instant, 24/7 (Zero Queue)',
  },
  {
    feature: 'Account Inquiries',
    without: 'Manual lookup by support staff',
    withColdi: 'Automated KYC/Balance checks',
  },
  {
    feature: 'First-Call Resolution',
    without: 'Multiple transfers to specialists',
    withColdi: 'High through AI triage',
  },
  {
    feature: 'Outbound Alerts',
    without: 'Manual, slow outreach',
    withColdi: 'Automated Margin/Trade calls',
  },
  {
    feature: 'Data Integrity',
    without: 'Manual, error-prone data entry',
    withColdi: 'Automatic CRM logging',
  },
  {
    feature: 'Global Reach',
    without: 'Limited by shift/staff language',
    withColdi: '30+ languages natively',
  },
  {
    feature: 'Scalability',
    without: 'Hiring/outsourcing required',
