...
const rows: Row[] = [
  {
    ...
    without: 'Limited to working hours',
    withColdi: 'Instant, 24/7',
  },
  {
    feature: 'Policy inquiries',
    without: 'Agent-handled',
  ...
  },
  {
    ...
    without: 'High call center volume',
  ...
  },
  {
    ...
    without: 'High call pressure',
    withColdi: 'Reduced for agents',
  },
  {
    feature: 'Scalability',
    without: 'Requires hiring more staff',
    withColdi: 'Unlimited conversations',
  },
];
